describe('Blog app', function () {
  beforeEach(function () {
    ...
    cy.request('POST', 'http://localhost:3003/api/users/', aUser)
  ...
  describe('when logged in', function () {
    ...
    describe('when blogs have been created', function () {
      beforeEach(function () {
        cy.create('cypressblog', 'cypress', 'https://www.edgerunning.nc')
        cy.create('Hello World', 'machine', 'https://www.mozilla.org')
        cy.create('Unexpected Journey', 'Bilbo Baggins', 'https://www.middle-earth.com')
        cy.visit('http://localhost:3000')
      })
      ...
      it('Owner of the blog can delete a blog', function () {
        ...
        cy.get('.notification').should(
          'contain',
          'Removed blog cypressblog by cypress from the collection'
        )
      })
